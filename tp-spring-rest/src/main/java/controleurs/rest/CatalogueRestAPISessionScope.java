...
/**
 * Contrôleur REST avec portée SessionScope
 * Chaque session utilisateur a sa propre instance du contrôleur
 */
@RestController
@RequestMapping("/catalogue-session")
@Scope(value = WebApplicationContext.SCOPE_SESSION)
public class CatalogueRestAPISessionScope {
